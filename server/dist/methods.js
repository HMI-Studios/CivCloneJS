...
(() => __awaiter(void 0, void 0, void 0, function* () {
    const game = yield game_1.Game.load('singleplayer test');
    const newID = Number(Object.keys(exports.games)[Object.keys(exports.games).length - 1]) + 1;
    exports.games[newID] = game;
}))();
const createGame = (username, playerCount, mapOptions, options) => {
    const newID = Number(Object.keys(exports.games)[Object.keys(exports.games).length - 1]) + 1;
    exports.games[newID] = new game_1.Game([
        new generator_1.PerlinWorldGenerator(options.seed, mapOptions),
        {
            playerCount,
            ownerName: username,
