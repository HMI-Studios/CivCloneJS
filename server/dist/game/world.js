...
class World {
    ...
    static import(data) {
        ...
        for (const civID in data.civs) {
            ...
            world.civs[Number(civID)] = civilization_1.Civilization.import(civData);
        ...
        for (const leaderID in leaderPool) {
            const leaderData = data.leaderPool[leaderID];
            world.leaderPool[Number(leaderID)] = leader_1.Leader.import(leaderData);
