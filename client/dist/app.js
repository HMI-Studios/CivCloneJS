...
const loadLocale = () => __awaiter(this, void 0, void 0, function* () {
    if (!localStorage.getItem('lang'))
        localStorage.setItem('lang', prompt('Language? (en)'));
    try {
        const localeResponse = yield fetch(`locales/${localStorage.getItem('lang')}.json`);
        locale = yield localeResponse.json();
    }
    catch (err) {
